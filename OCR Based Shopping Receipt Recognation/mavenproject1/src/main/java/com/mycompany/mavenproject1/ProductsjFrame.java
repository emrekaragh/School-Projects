...
public class ProductsjFrame extends javax.swing.JFrame {
    ...
    public ProductsjFrame() {
        initComponents();
        setDefaultCloseOperation(ProductsjFrame.DISPOSE_ON_CLOSE);
    }

    public ProductsjFrame(ResultSet gelenRS) {
        initComponents();
        this.rs = gelenRS;
        setDefaultCloseOperation(ProductsjFrame.DISPOSE_ON_CLOSE);
    ...
    public void fillTable() throws SQLException {
        while (rs.next()) {
            ...
            model.addRow(new Object[]{urun});
        }
    }
    
    public void fillTable2(DefaultTableModel model) throws SQLException {
